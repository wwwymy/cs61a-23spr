...
def picky_piggy(score):
    ...
    """
    # BEGIN PROBLEM 2
    if score == 0 or score%6 ==0:
        return 7
    else:
        num = 142857
        i = 7 - score%6
        while i>0:
            sscore,num = num%10,num//10
            i -= 1
        return sscore
    # END PROBLEM 2
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say_higher(score0,score1):
        ...
        if new_high > running_high:
            if who == 0:
                print(new_high, "point(s)! That's a record gain for Player 0!")
            if who == 1:
                print(new_high, "point(s)! That's a record gain for Player 1!")
